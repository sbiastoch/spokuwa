...
class System
{
    const STATE_DEACTIVATED = 0;
    const STATE_PREPARATION = 1;
    const STATE_SELECTION = 2;
    ...
    /**
     * Set deactivateStudents
     *
     * @param boolean $deactivateStudents
     * @return System
     */
    public function setDeactivateStudents($deactivateStudents)
    {
        $this->deactivateStudents = $deactivateStudents;
    
        return $this;
    }

    /**
     * Get deactivateStudents
     *
     * @return boolean 
     */
    public function getDeactivateStudents()
    {
        return $this->deactivateStudents;
    }
}