...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'spokuwa', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => '***REMOVED***', 'driver' => 'pdo_mysql', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'E:/xampp/htdocs/Symfony/app/cache/prod/jms_diextra/doctrine/EntityManager_50de0d79d5a5d.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_923bd0cafe3bfd5074daffdc675c0d45');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_923bd0cafe3bfd5074daffdc675c0d45');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_923bd0cafe3bfd5074daffdc675c0d45');
        ...
        $e->setProxyDir('E:/xampp/htdocs/Symfony/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager50de0d79d5a5d_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('E:/xampp/htdocs/Symfony/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_CLIENT' => array(0 => 'ROLE_STUDENT'), 'ROLE_ADMIN' => array(0 => 'ROLE_STUDENT', 1 => 'ROLE_CLIENT', 2 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('E:/xampp/htdocs/Symfony/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('E:/xampp/htdocs/Symfony/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => 'E:/xampp/htdocs/Symfony/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $a = $this->get('security.context');
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => 'E:/xampp/htdocs/Symfony/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'E:/xampp/htdocs/Symfony/app/../web', false);
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('E:/xampp/htdocs/Symfony/app/cache/prod/jms_security/expressions');
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('E:/xampp/htdocs/Symfony/app/cache/prod/jms_security', false));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'session.save_path' => 'E:/xampp/htdocs/Symfony/app/cache/prod/sessions',
            ...
            'swiftmailer.spool.memory.path' => 'E:/xampp/htdocs/Symfony/app/cache/prod/swiftmailer/spool',
            ...
            'jms_aop.cache_dir' => 'E:/xampp/htdocs/Symfony/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'E:/xampp/htdocs/Symfony/app/cache/prod/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'E:/xampp/htdocs/Symfony/app/cache/prod/jms_diextra/doctrine/EntityManager_50de0d79d5a5d.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager50de0d79d5a5d_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'E:/xampp/htdocs/Symfony/app/cache/prod/jms_security',
