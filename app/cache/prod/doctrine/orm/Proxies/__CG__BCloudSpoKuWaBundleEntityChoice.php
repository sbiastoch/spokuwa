 ...
 */
class Choice extends \BCloud\SpoKuWaBundle\Entity\Choice implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'priority', 'lastChanged', 'course', 'student');
    }
